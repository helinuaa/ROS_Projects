...
#include "demo/demo_actionAction.h"
#include <iostream>
#include <sstream>
...
protected:
  ...
  actionlib::SimpleActionServer<demo::demo_actionAction> as; 
  // create messages that are used to published feedback/result
  demo::demo_actionFeedback feedback;
  demo::demo_actionResult result;
...
public:
  ...
  void executeCB(const demo::demo_actionGoalConstPtr &goal)
  {
