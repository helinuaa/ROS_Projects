...
"""autogenerated by genpy from demo/demo_actionActionResult.msg. Do not edit."""
import sys
...
class demo_actionActionResult(genpy.Message):
  ...
  _type = "demo/demo_actionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','demo/demo_actionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = demo.msg.demo_actionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = demo.msg.demo_actionResult()
