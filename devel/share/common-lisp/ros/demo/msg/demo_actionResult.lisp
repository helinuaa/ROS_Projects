...
(cl:defmethod cl:initialize-instance :after ((m <demo_actionResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'demo_actionResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name demo-msg:<demo_actionResult> is deprecated: use demo-msg:demo_actionResult instead.")))

(cl:ensure-generic-function 'final_count-val :lambda-list '(m))
(cl:defmethod final_count-val ((m <demo_actionResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo-msg:final_count-val is deprecated.  Use demo-msg:final_count instead.")
  (final_count m))
